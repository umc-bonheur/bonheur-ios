...
class StatsByHourView: BarChartView {
    ...
    let greenLbl = UILabel().then {
        $0.attributedText = NSMutableAttributedString(string: "밤", attributes: [NSAttributedString.Key.kern: 0.04])
    ...
    var daysOfTheWeek = ["아침", "오후", "저녁", "밤", "새벽"]
    let unitsRecorded = [19.0, 21.0, 13.0, 24.0, 13.0]
